			...
			<view class="tui-product-title tui-border-radius">
				<view class="tui-pro-pricebox tui-padding">
					<view class="tui-pro-price">
						...
						<tui-tag padding="10rpx 20rpx" size="24rpx" plain type="high-green" shape="circle" :scaleMultiple="0.8" v-if="goodsdetail.label">{{goodsdetail.label}}</tui-tag>
					</view>
		...
		<tui-bottom-popup :show="popupShow" @close="hidePopup">
			<view class="tui-popup-box">
				...
				<view class="tui-operation tui-operation-right tui-right-flex tui-popup-btn">
					<view class="tui-flex-1">
						<tui-button height="72rpx" :size="28" type="danger" shape="circle" @click="addGoodsChange">加入购物车</tui-button>
					</view>
					<view class="tui-flex-1">
	...
	export default {
		...
		methods: {
			...
			submit() {
				...
				this.popupShow = false;
				uni.navigateTo({
					url: '../submitOrder/submitOrder?goods_type=0&goods_id='+goods_id+'&goodsNumber='+goodsNumber+'&specKeyId='+specKeyId
				});
			},
			coupon() {
				uni.navigateTo({
